...
def argument_parser():
    ...
    parser.add_argument('--regressors',
                        ...
                        choices=["CDFRegressorWeightedMean", "CDFRegressorLargestDiff"],
                        required=True)
...
if __name__ == "__main__":
    ...
    for bins in bins_to_explore:
        cmd_list.append("python data_processing.py --dataset_path=\"../data/cleaned/{}/data.csv\" --n_bins=\"{}\" --log_lvl=\"{}\" --save_thresholds True"
                        .format(args.dataset_name, bins, args.log_lvl))
    ...
    for classifier in args.classifiers:
        for regressor in args.regressors:
            for bins in bins_to_explore:
                cmd_list.append("python generate_predictions.py --dataset_folder=\"../data/extracted_features/{}/{}_bins_{}_{}/{}/\" --regressor=\"{}\" --log_lvl=\"{}\""
                                .format(args.dataset_name, bins, args.split_method, args.output_classes, classifier.split('.')[-1] + '_classifier', regressor, args.log_lvl))
