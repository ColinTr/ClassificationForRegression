            ...
            if len(regressor_list) > 0:
                ...
                for regressor_name in regressor_list.keys():
                    ...
                    for key, value in classifier_metrics_dict.items():
                        ...
                        plt.plot(mean_test_metric_df["x"], mean_test_metric_df["y"], label='test w/ ' + key, marker='o')
                    ...
                    for key, value in classifier_metrics_dict.items():
                        ...
                        plt.plot(mean_train_metric_df["x"], mean_train_metric_df["y"], label='train w/ ' + key, marker='o')
                    ...
                    plt.savefig(os.path.join(output_path,  metric + '_' + steps_encoding_method + '_' + class_generation_method + '_' + regressor_name + '.png'))
                    # ===========================
